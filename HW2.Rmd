...
# Source: https://stackoverflow.com/questions/41754220/plot-a-roc-curve-in-r-without-using-any-packages

ROC <- function(x, y, data){
  ...
  ggplot(xy, aes(x = FPR, y = TPR)) +
    geom_line(color = "blue") +
    geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "red") +
    labs(title = "ROC Curve", x = "False Positive Rate", y = "True Positive Rate") +
    annotate("text", x = 0.6, y = 0.4, label = paste("AUC =", AUC), size = 5, color = "black")
}

ROC(matrix_df$class,matrix_df$scored.probability)
